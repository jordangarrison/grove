...
pub(crate) trait DiscoveryService {
    fn bootstrap_data_for_projects(&self, projects: &[ProjectConfig]) -> BootstrapData;
}

#[derive(Debug, Clone, Copy, Default)]
pub(crate) struct CommandDiscoveryService;
...
impl DiscoveryService for CommandDiscoveryService {
    fn bootstrap_data_for_projects(&self, projects: &[ProjectConfig]) -> BootstrapData {
...
pub(crate) fn bootstrap_data_for_projects(projects: &[ProjectConfig]) -> BootstrapData {
    CommandDiscoveryService.bootstrap_data_for_projects(projects)
}
